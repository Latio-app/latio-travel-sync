...
const mockRecommendations: Recommendation[] = [
  ...
  },
  {
    ...
    response: "Take a free walking tour of the colorful La Boca neighborhood. Visit the MALBA museum on Wednesdays when admission is discounted. Enjoy the public parks and free outdoor tango performances in San Telmo on Sundays.",
  ...
  },
  {
    ...
    response: "Use authorized taxi services like Uber or Cabify for safety. The Metropolitano bus system is efficient for moving around the main areas. Avoid hailing taxis from the street, especially at night.",
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      const newRecommendation: Recommendation = {
        ...
        prompt,
        response: "Based on your request, I recommend exploring local markets and street food vendors for authentic cuisine. Always carry small bills for easier transactions and be sure to check if the vendor accepts cards before ordering.",
        timestamp: new Date().toISOString(),
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="mb-6 animate-fade-in">
          <LatioCard className="bg-white">
            <h3 className="font-medium text-gray-800 mb-4">Ask for Recommendations</h3>
        ...
        <div className="space-y-4 animate-fade-in" style={{ animationDelay: "100ms" }}>
          ...
          {recommendations.length === 0 && (
            <div className="text-center py-12">
              <p className="text-gray-500">No recommendations yet. Ask your first question!</p>
            </div>
          )}
        </div>
      </PageContainer>
